...
import io
from common import (
    USE_GSHEETS, USERS_FILE, DIR_COMPROBANTES, DIR_BACKUPS,
    ...
    obtener_tasa_usd_uyu, load_users, restaurar_tab,
    has_secret, get_secret,
)

# Sección "Obra" de La Serena. Se ejecuta como página de App.py (que hace set_page_config, estilos y login).
...
# --- GUARDIA DE LOGIN (el login lo hace App.py) ---
